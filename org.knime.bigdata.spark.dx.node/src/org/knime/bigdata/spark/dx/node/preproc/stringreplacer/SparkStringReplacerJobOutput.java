...
/**
 * Job output for the Spark String Replacer job.
 */
@SparkClass
public class SparkStringReplacerJobOutput extends JobOutput {

    private static final String PREVIEW_DATA = "previewData";

    /** Deserialization constructor. */
    public SparkStringReplacerJobOutput() {
    }
     ...
     */
    public SparkStringReplacerJobOutput(final String outputObject, final IntermediateSpec outputSpec) {
